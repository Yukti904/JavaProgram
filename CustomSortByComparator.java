...
class SortByFirstName implements java.util.Comparator{
    ...
    public int compare(Object firstObj, Object secondObj){
            String stringA[] = ((Employee)firstObj).getName().split(" ");
            String stringB[] = ((Employee)secondObj).getName().split(" ");

        return stringA[0].toLowerCase().compareTo(stringB[0].toLowerCase());
    }
}
